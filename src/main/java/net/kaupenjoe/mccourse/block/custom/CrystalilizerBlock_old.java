...
public class CrystalilizerBlock_old extends HorizontalFacingBlock {
    public static final MapCodec<CrystalilizerBlock_old> CODEC = createCodec(CrystalilizerBlock_old::new);

    public CrystalilizerBlock_old(Settings settings) {
        super(settings);
    }
