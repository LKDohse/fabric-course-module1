...
public class DodoModel extends SinglePartEntityModel<DodoEntity> {
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        ModelPartData left_leg_lower = left_leg.addChild("left_leg_lower", ModelPartBuilder.create().uv(79, 48).cuboid(-1.5F, 0.0069F, -1.5F, 3.0F, 12.0F, 3.0F, new Dilation(0.1F)).uv(79, 112).cuboid(-1.5F, 0.0069F, -1.5F, 3.0F, 12.0F, 3.0F, new Dilation(0.35F)), ModelTransform.pivot(0.0F, 6.0F, 0.0F));
        ...
        ModelPartData right_leg_lower = right_leg.addChild("right_leg_lower", ModelPartBuilder.create().uv(79, 112).cuboid(-1.5F, 0.0F, -1.5F, 3.0F, 12.0F, 3.0F, new Dilation(0.35F)).uv(79, 48).cuboid(-1.5F, 0.0F, -1.5F, 3.0F, 12.0F, 3.0F, new Dilation(0.1F)), ModelTransform.pivot(0.0F, 6.0F, 0.0F));
        ...
        ModelPartData eye_mirrored_r1 = head.addChild("eye_mirrored_r1", ModelPartBuilder.create().uv(100, 0).mirrored().cuboid(-3.25F, -5.0F, -2.0F, 1.0F, 3.0F, 3.0F, new Dilation(0.0F)).mirrored(false).uv(100, 0).cuboid(2.25F, -5.0F, -2.0F, 1.0F, 3.0F, 3.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 0.0F, 0.0F, 0.0F, 3.1416F, 0.0F));
    ...
    @Override
    public void setAngles(DodoEntity entity, float limbSwing, float limbSwingAmount, float animationProgress, float headYaw, float headPitch) {
        this.getPart().traverse().forEach(ModelPart::resetTransform);
        this.setHeadAngles(headYaw, headPitch);

        this.animateMovement(DodoAnimations.ANIM_DODO_WALK, limbSwing, limbSwingAmount, 2f, 2.5f);
        this.updateAnimation(entity.idleAnimationState, DodoAnimations.ANIM_DODO_IDLE, animationProgress, 1f);
    }
