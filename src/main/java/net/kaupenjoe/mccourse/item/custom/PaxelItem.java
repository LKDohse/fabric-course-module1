...
public class PaxelItem extends MiningToolItem {
    public PaxelItem(ToolMaterial material, TagKey<Block> effectiveBlocks, Settings settings) {
    ...
    private Optional<BlockState> tryStrip(World world, BlockPos pos, @Nullable PlayerEntity player, BlockState
            state) {
